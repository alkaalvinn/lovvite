...
export const defaultData: BirthdayBashData = {
  ...
  message: "Come celebrate with us! There'll be music, food, and lots of fun. Let's make this birthday one for the books!",
  theme: "Neon Glow Party",
  activities: "DJ & Dancing, Photo Booth, Karaoke, Rooftop Fireworks",
  whatToBring: "Just yourself and good vibes! Gifts are not expected but always appreciated.",
  primaryColor: "#e11d48",
